...
if __name__ == "__main__":
    ...
    while isopen:
        ...
        #print(s_prev.size) #total de elementos
        #print(s_prev.shape) #96 x 96 x 3
        #print(s_prev.ndim) #dimensoes

        total_reward = 0.0
        steps = 0
        restart = False
        pairStatesActions = []
        pairStatesActions.append((s_prev,a))
        while True:
            s, r, done, info = env.step(a)
            aa = copy.deepcopy(a)
            total_reward += r
            pairStatesActions.append((s,aa))
            ...
            isopen = env.render()
            if done or restart:
                # salvar o modelo pairStatesActions no arquivo pairStatesActions.pkl
                with open('pairStatesActions3.pkl', 'wb') as file:
                    pkl.dump(pairStatesActions, file) 
                break
            elif isopen == False:
                break    
